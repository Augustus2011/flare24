...
def main():
    join = os.path.join
    task_name = r'Task_FLARE24'
    target_base = "/Users/kunkerdthaisong/intern_cariva/flare24/datasets/nnunet_data/nnUNet_raw_data_base/nnUNet_raw_data/Dataset500_FLARE"#join(nnUNet_raw_data, task_name)
    ...
    labels = {0: 'Background', 1: 'Liver', 2: 'Right_Kidney', 3: 'Spleen', 4: 'Pancreas',
